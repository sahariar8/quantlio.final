...
class queueOrderCodeFinal_Final extends Command
{
     ...
     * @var string
     */
    protected $signature = 'call:queueOrderCodeFinal_Final';
    ...
    public function handle()
    {
        ...
        $response = $this->_SchedulerJobController-> getAndStoreRequestedJsonDataSet();
        if (env('LOG_SCHEDULE_INFO') == 'yes') 
        {
