...
class GeneratePDFReportController extends Controller
{
    ...
    public function test_generateView_from_mock_output(PDFGenerationService $_pdfGenerationService)
    {
        try
        {
            $_pdfGenerationService->test_generatePDF_from_mock_output();
        }
        catch (Exception $ex ) 
        {
              dump('mock data output__exception :: ' .  $ex->getMessage());
        }
    }
