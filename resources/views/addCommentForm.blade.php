            ...
            <form id="commentForm" name="commentForm" class="form-horizontal" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="js-example-placeholder-multiple select2bs4" name="section[]" id="section"
                            multiple="multiple" data-placeholder="Select Sections" style="width: 100%;" required>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="select2bs4" name="inputTestName" id="inputTestName"
                            data-placeholder="Select Tests" style="width: 100%;" required>
                            @foreach($testDetails as $testDetail)
                            <option value="{{ $testDetail->id }}">{{ $testDetail->test_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="inputComment" id="inputComment" required
                            value="{{ old('inputComment') }}">
