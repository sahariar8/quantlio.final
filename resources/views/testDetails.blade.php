                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button type="button" class="btn btn-primary" id="addTest" data-toggle="modal"
                                            ...
                                            <ul class="list-inline m-0">
                                                <li class="list-inline-item">
                                                    ...
                                                    <button class="btn btn-success btn-sm rounded-0 edit" type="button"
                                                        ...
                                                        value="{{$test->id}}"><i class="fa fa-edit"></i></button>
                                                    @endcan
                                                </li>
                                                <li class="list-inline-item">
