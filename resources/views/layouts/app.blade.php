...
<head>
    ...
    <title>{{ config('app.name', 'Clin1') }}</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/trackOrders" class="brand-link">
                <span class="brand-text font-weight-light">{{ __('Clin1') }}</span>
            </a>
            <!-- Sidebar -->
            <div class="sidebar">
                <!-- Sidebar Menu -->
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="/request_dataset" class="nav-link">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    {{ __('Request DataSet') }}
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="/failed-pdf" class="nav-link">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
        ...
        <footer class="main-footer">
            <strong>{{ __('Copyright') }} <a href="#">{{ __('Clin1') }}</a>.</strong>
