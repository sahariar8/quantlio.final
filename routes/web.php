...
/*    Route::post('export-data', [HomeController::class, 'exportExcel']);
    ...
    Route::get('/failed-pdf', [FailedPDFController::class, 'index'])->name('failed-pdf');
    Route::delete('failed-pdf/delete', [FailedPDFController::class, 'destroy'])->name('delete.failed-pdf');

    Route::get('/request_dataset',[RequestDataSetController::class,'index']);
    ...
    // http://127.0.0.1:8000/report-pdf/1/235740-96fdd707-133c-4a08-ae4a-43f0a18def54

     Route::get('/test/pdf/mock', [GeneratePDFReportController::class, 'test_generateView_from_mock_output']); 
    // http://127.0.0.1:8000/test/pdf/mock

    //Clin-1
    Route::get('/getData', [DrugInteractionController::class, 'checkDrug']);
});
